...
def generate_metadata_json_string(real_filename: str, is_note: bool):
    return json.dumps({"real_filename": real_filename, "is_note": is_note, "creation_date": "00:00:0000"})
